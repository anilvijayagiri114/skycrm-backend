    ...
    <div class="section">
      ...
      ${teamsData
        .map((team) => {
          ...
          const teamProgress = (
            ((statusCount["Enrolled"] || 0) /
              (team.leadsAssigned?.length || 1)) *
            100
          ).toFixed(2);
          ...
          return `
            <div class="team-card">
              ...
              <div class="team-details">
                ...
                <p><strong>Leads Assigned:</strong> ${
                  team.leadsAssigned?.length || 0
                }</p>
      ...
      <head>
        ...
        <style>
          * { box-sizing: border-box; }
          ...
          .status-breakdown h3 {
            text-align: center;
            color: #1d4ed8; /* stronger blue heading */
            font-size: 15px;
            font-weight: 600;
            margin-bottom: 12px;
          }
...
page-break-inside: avoid;
      ...
      <body>
        ...
        <footer>
          © SkyCRM ${new Date().getFullYear()} — Auto-generated on ${generatedOn}
        </footer>
      </body>
    </html>
  `;
